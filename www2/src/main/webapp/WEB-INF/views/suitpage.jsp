    ...
    <table class="suit-table">
        <thead>
            <tr>
                ...
                <th>입고 날짜</th>
                <th>삭제</th>
                <a href="suitwr" style="padding-left: 590px;">
                	<input type="button" class="btn btn-primary" style="background-color: skyblue; border: none" value="정장 추가">
                </a>
            </tr>
        </thead>
        <tbody>
        <c:forEach items="${list }" var="suitvo">
            <tr>
                <td>${suitvo.suitcode }</td>
                <td>${suitvo.suitname }</td>
                <td>${suitvo.suitcontent }</td>
                <td>${suitvo.suitleft }</td>
                <td>${suitvo.indate }</td>
                <td>삭제</td>
            </tr>
          </c:forEach>
